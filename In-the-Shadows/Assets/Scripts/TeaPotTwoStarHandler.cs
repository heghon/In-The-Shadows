...
public class TeaPotTwoStarHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (transform.eulerAngles.y > 178f && transform.eulerAngles.y < 182f &&
            transform.eulerAngles.x > 5f && transform.eulerAngles.x < 9f &&
